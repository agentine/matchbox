...
### Added
- **CI pipeline** (`.github/workflows/ci.yml`) — automated test runs on Node 18/20/22 matrix
- **Benchmarks** (`benchmarks/bench.ts`) — performance suite covering glob matching, array filtering, regex compilation, brace expansion, range operations, and pattern scanning
